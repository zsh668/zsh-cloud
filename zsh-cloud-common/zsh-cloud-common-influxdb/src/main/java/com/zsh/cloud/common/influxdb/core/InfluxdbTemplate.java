...
import com.zsh.cloud.common.influxdb.InfluxdbProperties;
import com.zsh.cloud.common.influxdb.util.InfluxdbUtils;
...
public class InfluxdbTemplate {
     ...
     * 删除.
     *
     * 只允许根据tag和时间来进行删除操作 field字段删除无效
     *
     * 不推荐使用
     *
     * @param query sql语句
