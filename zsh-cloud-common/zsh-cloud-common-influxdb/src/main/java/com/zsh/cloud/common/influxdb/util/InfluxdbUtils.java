...
import com.zsh.cloud.common.influxdb.core.Query;
import com.zsh.cloud.common.influxdb.core.annotation.Aggregate;
import com.zsh.cloud.common.influxdb.core.annotation.Count;
...
public class InfluxdbUtils {
    ...
    /**
     * 保存 Point.Builder.field 虽然已过时 理论上不会被删除吧
     *
                ...
                if (column.tag()) {
                    ...
                    if (field.get(object) != null) {
                        if ("time".equals(column.name())) {
                            builder.time(CommonUtils.parseLocalDateTimeToInstant((LocalDateTime) field.get(object)).getEpochSecond(),
                                TimeUnit.SECONDS);
                        } else {
